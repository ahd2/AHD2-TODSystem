...
public class IBLTool : EditorWindow
{
    ...
    private void OnEnable()
    {
        ...
        cubemapList.drawHeaderCallback = (Rect rect) =>
        {
            EditorGUI.LabelField(rect, "Cubemaps");
        };
        ...
        cubemapList.onRemoveCallback = (ReorderableList list) =>
        {
            cubemaps.RemoveAt(list.index);
        };
    }
    private void OnGUI()
    {
